...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <UpdateEnvioMailGeneral xmlns="http://tempuri.org/">
      ...
      http.Response response = await http.post(
        ...
        'SOAPAction'  : 'http://tempuri.org/UpdateEnvioMailGeneral'
        }, 
  ...
  try {
    ...
    final elements = raw.findAllElements('UpdateEnvioMailGeneralResult');
...
final limpiezaProvider = new LimpiezaProvider();